...
# din not image, path
d_p_2 = os.path.join(path, 'p1_walk')
...
class Dino(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.stand = os.path.join(path, 'p1_stand.png')
        self.jump_img = os.path.join(path, 'p1_jump.png')
        self.hurt_img = os.path.join(path, 'p1_hurt.png')
        ...
        # set pos
        self.rect.midbottom = (screen_size[0]/ 2, screen_size[1])  # botom on ground mid x
        self.air = False
        self.vel = 0
